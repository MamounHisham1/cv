    ...
    <div class="no-print fixed top-4 right-4 z-50 flex gap-2">
        <div class="relative">
            <button @click="open = !open" class="px-4 py-2 bg-emerald-600 text-white rounded-lg shadow hover:bg-emerald-700 flex items-center gap-2">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>{{ __("Download") }}</button>
            <div x-show="open" x-transition @keydown.escape.window="open = false"
                ...
                <a href="{{ route('cv.export.public', [$cv, 'pdf']) }}" class="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">{{ __("PDF") }}</a>
