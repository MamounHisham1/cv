                ...
                <table role="presentation" width="100%" style="max-width: 480px; background-color: #ffffff; border-radius: 16px; box-shadow: 0 4px 6px -1px rgb(0 0 0 / 0.1), 0 2px 4px -2px rgb(0 0 0 / 0.1);">
                    ...
                    <tr>
                        <td style="padding: 10px 40px;">
                            ...
                            <p style="margin: 12px 0 0 0; font-size: 16px; color: #3f3f46; line-height: 1.6;">{{ __("Credits have been added to your account!") }}</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 30px 40px;">
                            <div style="background: linear-gradient(135deg, #059669 0%, #10b981 100%); border-radius: 12px; padding: 30px; text-align: center;">
                                <p style="margin: 0 0 4px 0; font-size: 13px; font-weight: 500; color: rgba(255, 255, 255, 0.8); text-transform: uppercase; letter-spacing: 1px;">{{ __("Credits Added") }}</p>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td style="padding: 12px 0; border-bottom: 1px solid #e4e4e7;">
                                        <p style="margin: 0; font-size: 13px; color: #71717a;">{{ __("Reason") }}</p>
                                        <p style="margin: 4px 0 0 0; font-size: 15px; color: #18181b; font-weight: 500;">{{ $reason }}</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding: 12px 0;">
                                        <p style="margin: 0; font-size: 13px; color: #71717a;">{{ __("New Balance") }}</p>
                    ...
                    <tr>
                        <td style="padding: 20px 40px;" align="center">
                            <a href="{{ route('credits.history') }}" style="display: inline-block; padding: 12px 32px; background-color: #18181b; color: #ffffff; text-decoration: none; border-radius: 8px; font-size: 14px; font-weight: 600;">{{ __("View Credit History") }}</a>
                        </td>
                    </tr>
