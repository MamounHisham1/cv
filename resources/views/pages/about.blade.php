    ...
    <main>
        ...
        <section class="bg-gradient-to-br from-emerald-600 via-emerald-700 to-emerald-800 py-20 lg:py-28">
            <div class="mx-auto max-w-7xl px-6 lg:px-8 text-center">
                <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">About CVForge</h1>
        ...
        <section class="py-20 lg:py-28 bg-white dark:bg-zinc-950">
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    <div>
                        <flux:badge variant="subtle" color="emerald" class="mb-4">Our Mission</flux:badge>
                        ...
                        <p class="text-zinc-600 dark:text-zinc-400 leading-relaxed mb-4">
                            CVForge was founded in 2024 by a team of hiring managers, career coaches, and software engineers who saw a critical gap in the job application process. Millions of talented professionals were being filtered out by ATS systems, not because they lacked qualifications, but because their CVs were not optimized for the technology screening them.
                        </p>
                        <p class="text-zinc-600 dark:text-zinc-400 leading-relaxed mb-4">
                            We built CVForge to level the playing field. Our AI analyzes job descriptions in real time, identifies the keywords and competencies that ATS systems prioritize, and helps candidates present their experience in the most impactful way possible.
                        </p>
                        <p class="text-zinc-600 dark:text-zinc-400 leading-relaxed">
                            Today, over 10,000 professionals trust CVForge to power their job searches, and we are proud to report a 95% ATS pass rate among our users. We are just getting started.
                        </p>
                    </div>
                        ...
                        <div class="relative w-full max-w-md">
                            <div class="aspect-square rounded-2xl bg-gradient-to-br from-emerald-100 to-emerald-200 dark:from-emerald-900/30 dark:to-emerald-800/30 flex items-center justify-center">
                                <div class="text-center p-8">
                                    <flux:icon name="trophy" class="size-20 text-emerald-600 dark:text-emerald-400 mx-auto mb-6" variant="solid" />
        ...
        <section class="py-20 lg:py-28 bg-zinc-50 dark:bg-zinc-900">
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="text-center max-w-2xl mx-auto mb-16">
                    <flux:badge variant="subtle" color="emerald" class="mb-4">Why Choose Us</flux:badge>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
                    <flux:card class="hover:border-emerald-300 dark:hover:border-emerald-700 transition-all duration-200">
                        <div class="p-6 lg:p-8 text-center">
                            <div class="w-12 h-12 rounded-xl bg-emerald-100 dark:bg-emerald-900/30 flex items-center justify-center mx-auto mb-5">
                                <flux:icon name="academic-cap" class="size-6 text-emerald-600 dark:text-emerald-400" variant="solid" />
                            </div>
                    ...
                    <flux:card class="hover:border-emerald-300 dark:hover:border-emerald-700 transition-all duration-200">
                        <div class="p-6 lg:p-8 text-center">
                            <div class="w-12 h-12 rounded-xl bg-emerald-100 dark:bg-emerald-900/30 flex items-center justify-center mx-auto mb-5">
                                <flux:icon name="heart" class="size-6 text-emerald-600 dark:text-emerald-400" variant="solid" />
                            </div>
        ...
        <section class="py-20 lg:py-28 bg-white dark:bg-zinc-950">
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="text-center max-w-2xl mx-auto mb-16">
                    <flux:badge variant="subtle" color="emerald" class="mb-4">Our Team</flux:badge>
                    <h2 class="text-3xl md:text-4xl font-bold text-zinc-900 dark:text-white mb-4">
                        Meet the People Behind CVForge
                    </h2>
                    <p class="text-lg text-zinc-600 dark:text-zinc-400">
