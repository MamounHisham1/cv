                                ...
                                <div class="space-y-5">
                                    <div class="flex items-start gap-4">
                                        <div class="w-10 h-10 rounded-lg bg-emerald-100 dark:bg-emerald-900/30 flex items-center justify-center shrink-0">
                                            <x-ui::icon name="mail" size="md" class="text-emerald-600 dark:text-emerald-400" />
                                        </div>
                                        <div>
                                    ...
                                    <div class="flex items-start gap-4">
                                        <div class="w-10 h-10 rounded-lg bg-emerald-100 dark:bg-emerald-900/30 flex items-center justify-center shrink-0">
                                            <x-ui::icon name="phone" size="md" class="text-emerald-600 dark:text-emerald-400" />
                                        </div>
                                        <div>
                                    ...
                                    <div class="flex items-start gap-4">
                                        <div class="w-10 h-10 rounded-lg bg-emerald-100 dark:bg-emerald-900/30 flex items-center justify-center shrink-0">
                                            <x-ui::icon name="map-pin" size="md" class="text-emerald-600 dark:text-emerald-400" />
                                        </div>
                                        <div>
                            ...
                            <div class="p-6 lg:p-8">
                                ...
                                <div class="flex items-center gap-3">
                                    <a href="#" class="w-10 h-10 rounded-lg bg-zinc-100 dark:bg-zinc-800 flex items-center justify-center text-zinc-500 dark:text-zinc-400 hover:bg-emerald-100 dark:hover:bg-emerald-900/30 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors">
                                        <x-ui::icon name="globe" size="md" />
                                    </a>
                                    <a href="#" class="w-10 h-10 rounded-lg bg-zinc-100 dark:bg-zinc-800 flex items-center justify-center text-zinc-500 dark:text-zinc-400 hover:bg-emerald-100 dark:hover:bg-emerald-900/30 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors">
                                        <x-ui::icon name="code-2" size="md" />
                                    </a>
                                    <a href="#" class="w-10 h-10 rounded-lg bg-zinc-100 dark:bg-zinc-800 flex items-center justify-center text-zinc-500 dark:text-zinc-400 hover:bg-emerald-100 dark:hover:bg-emerald-900/30 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors">
                                        <x-ui::icon name="users" size="md" />
                                    </a>
                                </div>
                            </div>
                        </x-ui::card>
