...
<x-ui::dialog name="confirm-user-deletion" :show="$errors->isNotEmpty()" focusable class="max-w-lg">
    <form method="POST" wire:submit="deleteUser" class="space-y-6">
        <div>
            <x-ui::heading size="lg">{{ __('Are you sure you want to delete your account?') }}</x-ui::heading>

            <x-ui::text size="lg" muted>
        ...
        <div class="flex justify-end space-x-2 rtl:space-x-reverse">
            <x-ui::button variant="secondary" @click="$dispatch('close-dialog', 'confirm-user-deletion')">
                {{ __('Cancel') }}
            </x-ui::button>
