...
export const CvBuilderScene: React.FC = () => {
    ...
    <AbsoluteFill style={{ backgroundColor: COLORS.bg, overflow: 'hidden', padding: 50 }}>
      <div style={{ display: 'flex', flexDirection: 'row', gap: 20, height: '100%', alignItems: 'stretch' }}>
        ...
        >
          ...
          <div style={{ fontSize: 32, fontWeight: 700, fontFamily: FONT.primary, color: COLORS.white, lineHeight: 1.3 }}>
            {visibleTitle}
          ...
          <div style={{ fontSize: 22, fontWeight: 400, fontFamily: FONT.primary, color: COLORS.zinc400, lineHeight: 1.5, marginBottom: 20 }}>
            {visibleDesc}
        ...
        >
          <div style={{ fontSize: 20, fontWeight: 700, fontFamily: FONT.primary, color: COLORS.emerald400, letterSpacing: '0.05em', textTransform: 'uppercase' }}>
            AI Suggestions
          </div>

          <div style={{ display: 'flex', alignItems: 'center', gap: 14, padding: '16px 18px', background: 'rgba(16, 185, 129, 0.08)', borderRadius: 14, border: '1px solid rgba(16, 185, 129, 0.15)' }}>
            <span style={{ fontSize: 22 }}>+</span>
            <span style={{ fontSize: 20, fontWeight: 500, fontFamily: FONT.primary, color: COLORS.zinc300 }}>Quantifiable impact metrics</span>
          </div>

          <div style={{ display: 'flex', alignItems: 'center', gap: 14, padding: '16px 18px', background: 'rgba(16, 185, 129, 0.08)', borderRadius: 14, border: '1px solid rgba(16, 185, 129, 0.15)' }}>
            <span style={{ fontSize: 22 }}>#</span>
            <span style={{ fontSize: 20, fontWeight: 500, fontFamily: FONT.primary, color: COLORS.zinc300 }}>ATS keyword optimization</span>
          </div>

          <div style={{ display: 'flex', alignItems: 'center', gap: 14, padding: '16px 18px', background: 'rgba(16, 185, 129, 0.08)', borderRadius: 14, border: '1px solid rgba(16, 185, 129, 0.15)' }}>
            <span style={{ fontSize: 22 }}>T</span>
            <span style={{ fontSize: 20, fontWeight: 500, fontFamily: FONT.primary, color: COLORS.zinc300 }}>Modern template selection</span>
          </div>
