...
const RINGS = [
  { label: 'كلمات مفتاحية', max: 98 },
  { label: 'تنسيق', max: 95 },
  { label: 'تأثير', max: 88 },
];

export const AtsScoreSceneArabic: React.FC = () => {
      ...
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 48, zIndex: 1 }}>
        ...
        >
          ...
          >
            ...
            <div style={{ fontSize: 20, fontWeight: 500, fontFamily: ARABIC_FONT, color: COLORS.zinc500 }}>
              / 100
            </div>
          </div>
        </div>
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    >
                      <span style={{ fontSize: 30, fontWeight: 800, fontFamily: ARABIC_FONT, color: COLORS.white }}>
                        {itemScore}%
                      </span>
                    </div>
                  </div>
                  <span style={{ fontSize: 22, fontWeight: 500, fontFamily: ARABIC_FONT, color: COLORS.zinc400 }}>
                    {ring.label}
                  </span>
                </div>
              );
