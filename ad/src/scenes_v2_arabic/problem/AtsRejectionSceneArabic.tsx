...
export const AtsRejectionSceneArabic: React.FC = () => {
    ...
    >
      ...
      >
        ...
        {scoreAppear && (
          ...
          >
            <div style={{ fontSize: 18, fontWeight: 700, fontFamily: ARABIC_FONT, color: '#fca5a5', letterSpacing: '0.06em' }}>
              توافق
            </div>
            <div style={{ fontSize: 56, fontWeight: 900, fontFamily: ARABIC_FONT, color: '#ef4444', lineHeight: 1.1 }}>
              45%
            </div>
            <div style={{ fontSize: 16, fontWeight: 700, fontFamily: ARABIC_FONT, color: '#fca5a5', letterSpacing: '0.05em' }}>
              أقل من المطلوب
            </div>
          </div>
        )}
      ...
      {rejectAppear && (
        ...
        >
          قبل ما أي إنسان يشوفها، روبوت بيرفضها
        </div>
      )}
