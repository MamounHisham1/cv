  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 48, zIndex: 1 }}>
        ...
        >
          <div style={{ color: COLORS.white, fontSize: 52, fontWeight: 800, fontFamily: ARABIC_FONT, letterSpacing: -1, direction: 'rtl' }}>
            أول إنترفيو مجاني
          </div>
          <div style={{ color: 'rgba(255,255,255,0.85)', fontSize: 24, fontWeight: 500, fontFamily: ARABIC_FONT, marginTop: 8, direction: 'rtl' }}>
            جرب من غير أي مخاطرة. ابدأ النهارده.
          </div>
        </div>
        ...
        >
          ابنِ. طور. تقييم. — كل ده بالذكاء الاصطناعي
        </div>
      </div>
    </AbsoluteFill>
  );
