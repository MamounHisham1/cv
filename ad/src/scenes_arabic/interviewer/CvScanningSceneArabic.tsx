...
export const CvScanningSceneArabic: React.FC = () => {
  ...
  return (
    <AbsoluteFill className="arabic-text" style={{ backgroundColor: COLORS.bg, justifyContent: 'flex-start', alignItems: 'center', overflow: 'hidden', paddingTop: 130 * scale, paddingLeft: 80 * scale, paddingRight: 80 * scale }}>
      ...
      {/* --- TOP: Title --- */}
      <div style={{ opacity: titleOpacity, transform: `translateY(${titleY}px)`, textAlign: 'center', marginBottom: 50 * scale, zIndex: 10, width: '100%' }}>
      ...
      <div style={{ position: 'relative', width: '100%', height: 1100 * scale, display: 'flex', justifyContent: 'center', alignItems: 'center', zIndex: 1 }}>
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 14 * scale, alignItems: 'flex-start' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 14 * scale, marginTop: 12 * scale, alignItems: 'flex-start' }}>
          ...
          >
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 16 * scale }}>
              ...
              <div style={{ textAlign: 'right' }}>
                <div style={{ color: COLORS.white, fontSize: 16 * scale, fontWeight: 700 }}>مسؤول توظيف الذكاء الاصطناعي</div>
                <div style={{ color: COLORS.zinc500, fontSize: 12 * scale, textTransform: 'uppercase', marginTop: 2 * scale }}>سؤال مخصص</div>
              </div>
            </div>

            <p style={{ color: COLORS.white, fontSize: 24 * scale, fontWeight: 600, lineHeight: 1.6, fontStyle: 'normal', margin: 0, textAlign: 'right' }}>
              "سيرتك تبين إن عندك خبرة قوية بقواعد البيانات. احكِ لي كيف تعاملت مع مشكلة السيرفرات وقت الضغط العالي؟"
            </p>
          </div>
        )}
      ...
      >
        <p style={{ color: COLORS.zinc400, fontSize: 18 * scale, lineHeight: 1.6, maxWidth: 640 * scale, margin: '0 auto' }}>
          سيراتي يستخلص الإنجازات الرئيسية من سيرتك الذاتية ليتحداك بأسئلة حقيقية ومخصصة لك.
        </p>
      </div>
    </AbsoluteFill>
  );
